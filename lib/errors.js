...
util.extend(AdapterError, {
    ...
    TRANSACTION_ID_INTEGRITY_FAILURE: 'Transaction id integrity mismatch (report issue.)',

    NO_SOURCE: 'Connection source not found',
    UNKNOWN_CONNECTION: 'The connection was not found during multiplexing'
});
