...
util.extend(Mediator.prototype, /** @lends Mediator.prototype */ {
    create: function (values, callback) {
        ...
        if (typeof(callback) !== FN) {
            return Mediator.redeffer(self._model.create(this._transaction.wrap(values)), self._transaction);
        }
    ...
    update: function (criteria, values, callback) {
        ...
        // disallow promises
        if (typeof(callback) !== FN) {
            return Mediator.redeffer(self._model.update(criteria, self._transaction.wrap(values)), self._transaction);
        }
    ...
    destroy: function (criteria, callback) {
        ...
        if (typeof(callback) !== FN) {
            return Mediator.redeffer(self._model.destroy(self._transaction.wrap(criteria)), self._transaction);
        }
    ...
    findOne: function (criteria, callback) {
        ...
        // disallow promises
        if (typeof(callback) !== FN) {
            return Mediator.redeffer(self._model.findOne(criteria, undefined, self._transaction.id()), self._transaction);
        }
...
util.extend(Mediator, /** @lends Mediator */ {
    /**
     * This function accepts a deffer and a transaction object. It returns the same deffer object, but its `exec` function
     * gets overridden to wrap the results before executing the exec callback.
     *
     * @private
     * @param {deffer} defer
