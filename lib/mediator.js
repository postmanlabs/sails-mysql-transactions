...
util.extend(Mediator.prototype, /** @lends Mediator.prototype */ {
    create: function (values, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.create(this._transaction.wrap(values)), self._transaction.id());
        }
    ...
    update: function (criteria, values, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.update(criteria, self._transaction.wrap(values)), self._transaction.id());
        }
    ...
    destroy: function (criteria, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.destroy(self._transaction.wrap(criteria)), self._transaction.id());
        }
    ...
    findOrCreate: function (criteria, values, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.findOrCreate(criteria, values, undefined, id), id);
        }
    ...
    findOne: function (criteria, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.findOne(criteria, undefined, id), id);
        }
