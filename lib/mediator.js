...
util.extend(Mediator.prototype, /** @lends Mediator.prototype */ {
    create: function (values, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.create(this._transaction.wrap(values)), self._transaction);
        }
    ...
    update: function (criteria, values, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.update(criteria, self._transaction.wrap(values)), self._transaction);
        }
    ...
    destroy: function (criteria, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.destroy(self._transaction.wrap(criteria)), self._transaction);
        }
    ...
    findOrCreate: function (criteria, values, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.findOrCreate(criteria, values, undefined, self._transaction.id()),
                self._transaction);
        }
    ...
    findOne: function (criteria, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.findOne(criteria, undefined, self._transaction.id()),
                self._transaction);
        }
    ...
    find: function (criteria, options, callback) {
        ...
        if (typeof callback !== FN) {
            return util.redeffer(self._model.find(criteria, options, undefined, self._transaction.id()),
                self._transaction);
        }
